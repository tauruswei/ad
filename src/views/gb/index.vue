...
import CurRankList from "./components/rank-list-cur.vue";
import RankList from "./components/rank-list-his.vue";
import YestodayList from "./components/rank-list-yestoday.vue";
